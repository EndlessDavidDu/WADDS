...
vehicles
common
common_vehicles<-semi_join(vehicles, common)
common_vehicles
```

This didn't end up requiring as much work as I anticipated, so I will do a different problem as well for this chapter. 
