...
In the  above plot we can see a higher percent of premature births among smokers vs non-smokers. However, the difference is not large and may be due to other factors. 
...
Abby: I created a plot to determine if a baby's birthweight was impacted by the Father's weight. From those results I then created another set of plots to see if smoking made the relationship between Dad's weight and birthweight stronger or weaker. 
